...
public class AddChecklistItemViewHolder extends BaseViewHolder {

    private final AddChecklistItemListener addChecklistItemListener;

    public AddChecklistItemViewHolder(ViewGroup parent, AddChecklistItemListener addChecklistItemListener) {
